...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/hos_1.jpg" class="d-block= w-100" alt="..." height="850px">
    </div>
    <div class="carousel-item">
      <img src="img/hos_2.jpg" class="d-block w-100" alt="..." height="850px">
    </div>
    <div class="carousel-item">
      <img src="img/hos_3.jpg" class="d-block w-100" alt="..." height="850px">
    </div>
  </div>
